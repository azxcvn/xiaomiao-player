...
/// 单个颜色的编辑行：公共组件 [ColorEditorRow] 的薄包装。
///
/// 实现已抽到 `widgets/color_editor_row.dart`（弹幕「指定颜色」共用同一套交互）。
/// 这里保留私有子类，是为了不动本文件里既有的多处调用点（构造参数完全一致）。
class _ColorEditorRow extends ColorEditorRow {
